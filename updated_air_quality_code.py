"""
Updated Air Quality Data Collection Code

This file contains the updated code for fetching air quality data from Google Earth Engine.
Replace the air quality data section in your fetch_climate_data.py with this code.
"""
